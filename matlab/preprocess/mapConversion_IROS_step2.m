...
%to generate accumulative free space map based on all past #Sequence frames

worldNum = 7;

%imagelist = {38409, 15787, 11099, 22193, 3027,  24600, 29477};
imagelist = {0, 64, 11099, 22193, 3027,  24600, 29477};
...
for w = [2]
    ...
    %load(['pose/poseTBWorld' num2str(w) '.mat']); % for 2D3DS dataset
    %prefixGMP = ['/media/mengmi/TOSHIBA EXT/3DGAN/Nav3D_dataset/World' num2str(w) '/map_global/map_'];
    prefixGMPR = ['../../Data/world' num2str(w) '/map_global/map_'];

...
const double g_default_p_occupied_when_laser = 0.9;  //mengmi: 0.9
const double g_default_p_occupied_when_no_laser = 0.3; //mengmi: 0.3
const double g_default_large_log_odds = 100; 
const double g_default_max_log_odds_for_belief = 20; //mengmi: 20
